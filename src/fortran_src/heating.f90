...
MODULE heating
    ...
    USE DEFAULTPARAMETERS, only: outputDir
IMPLICIT NONE
 ...
 CONTAINS
    ...
    SUBROUTINE initializeHeating(gasTemperature, gasDensity,abundances,columnDensity,cloudSize,writeFlag)
        ...
        IF (writeFlag) THEN
            ...
            OPEN(15, FILE=TRIM(outputDir)//'/cooling_rates.csv', STATUS='unknown')
            OPEN(16, FILE=TRIM(outputDir)//'/heating_rates.csv', STATUS='unknown')
