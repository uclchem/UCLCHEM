...
!Set freefall to 1 if density should change via integrating a freefall equation
!we can slow the freefall with the factor bc.
freefall=0; bc=1.0
...
thermdesorb=1 !continuous thermal desorption - best have on for three phase and off for two phase
