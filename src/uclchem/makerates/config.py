...
class MakeratesConfig(BaseModel):
    ...
    @field_validator('database_reaction_file', 'custom_reaction_file', 'database_reaction_exothermicity', mode='before')
    @classmethod
    ...
    def validate_reaction_files_and_types(self):
        ...
        if self.custom_reaction_file is not None:
            ...
            if isinstance(self.custom_reaction_file, list) and isinstance(self.custom_reaction_type, list):
    ...
    @classmethod
    def generate_template(cls, output_path: Union[str, Path] = "user_settings_template.yaml"):
        """
...
"""
        ...
        print(f"  Edit this file and use it with: python MakeRates.py --config {output_path}")
    ...
    def print_help(cls):
        ...
        for field_name, field_info in cls.model_fields.items():
            ...
            req_text = "REQUIRED" if is_required else f"Optional (default: {field_info.default})"
        ...
        print("  python -c 'from uclchem.makerates.config import MakeratesConfig; MakeratesConfig.generate_template()'")
        print("=" * 80)
