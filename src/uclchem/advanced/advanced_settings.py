...
class Setting:
    ...
    def __init__(
        ...
        self.default_value = _copy_value(value)
        self.current_value = _copy_value(value)
    ...
    def __repr__(self) -> str:
        ...
        if isinstance(self.current_value, np.ndarray):
            ...
            if self.current_value.size <= 3:  # ruff: ignore[magic-value-comparison]
    ...
    def print_settings(
        ...
        for name in sorted(settings.keys()):
            ...
            if isinstance(setting.current_value, np.ndarray):
                if setting.current_value.size <= 5:  # ruff: ignore[magic-value-comparison]
...
class GeneralSettings:
    ...
    **Thread Safety Warning:**
    ...
    def print_all_edited(self) -> None:
