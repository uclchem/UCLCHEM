'''
This file contains the legacy methods for running UCLCHEM models with python. These functions are deprecated
 and will not be as up to date as the new class based API in model.py
'''
import warnings
import os
...
from uclchem.model import get_reaction_names
