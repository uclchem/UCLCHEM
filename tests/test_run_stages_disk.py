...
def test_static_model_disk(tmp_path):
    ...
    params = {
        ...
        "finalDens": 1e5,
        "finalTime": 5.0e6,
        "outputFile": str(tmp_path / "static-full.dat"),
        "abundSaveFile": str(tmp_path / "startstatic.dat"),
    }
...
def test_collapse_hotcore_disk(tmp_path):
    ...
    params = {
        ...
        "finalDens": 1e6,
        "finalTime": 1e5,
        "abundSaveFile": str(tmp_path / "startstage1.dat"),
        "outputFile": str(tmp_path / "stage1-full.dat"),
        "columnFile": str(tmp_path / "stage1-column.dat"),
    }
    return_code = uclchem.functional.cloud(
        param_dict=params, out_species=["OH", "OCS", "CO", "CS", "CH3OH"]
    )
    ...
    params = {
        ...
        "freefall": False,
        "finalTime": 1e6,
        "outputFile": str(tmp_path / "stage2-full.dat"),
        "abundLoadFile": str(tmp_path / "startstage1.dat"),
    }
...
def test_cshock_disk(tmp_path):
    ...
    param_dict = {
        ...
        "rout": 0.1,
        "baseAv": 1.0,
        "abundSaveFile": str(tmp_path / "start_cshock.dat"),
        "outputFile": str(tmp_path / "pre_cshock.dat"),
    }
    ...
    param_dict["abundLoadFile"] = str(tmp_path / "start_cshock.dat")
    param_dict["outputFile"] = str(tmp_path / "cshock.dat")
...
def test_endAtFinalDensity_validation_disk(tmp_path):  # ruff: ignore[invalid-function-name]
    ...
    params = {
        ...
        "initialDens": 1e4,
        "finalTime": 1e5,
        "outputFile": str(tmp_path / "invalid-test.dat"),
    }
