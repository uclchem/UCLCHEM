...
def test_parcel_radius_in_collapse_physics(collapse_mode):
    ...
    physics, chemistry, rates, heating, abundances, return_code = uclchem.functional.collapse(
...
def test_parcel_radius_zero_for_cloud():
    ...
    physics, chemistry, rates, heating, abundances, return_code = uclchem.functional.cloud(
