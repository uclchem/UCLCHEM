...
C       WRITE(9,30)T,IWORK(11),RWORK(11),(Y(I),I=1,NEQ)
...
C       IF (ISTATE .LT. 0) GO TO 80
C 40    TOUT = TOUT*10.
C     WRITE(9,60)IWORK(11),IWORK(12),IWORK(13),IWORK(19),RWORK(15)
C 60  FORMAT(/' No. steps =',I4,'  No. f-s =',I4,'  No. J-s =',I4/
...
C       WRITE(9,30)JROOT(1),JROOT(2)
C 30    FORMAT(5X,' The above line is a root,  JROOT =',2I5)
C       ISTATE = 2
C       GO TO 10
C 40    TOUT = TOUT*10.
C     WRITE(9,60)IWORK(11),IWORK(12),IWORK(13),IWORK(10),
...
C       TOUT = TOUT + 0.1
C  40   CONTINUE
C     WRITE(9,50) (Y(I),I=1,NEQ)
C  50 FORMAT(/' Final solution values..'/9(5D12.4/))
C     STOP
C  90 WRITE(9,95) ISTATE
...
C     WRITE(9,50) IW(17),IW(18),IW(11),IW(12),IW(13)
C     NNZLU = IW(25) + IW(26) + NEQ
C     WRITE(9,60) IW(19),NNZLU
